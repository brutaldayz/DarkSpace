        ...
        <div class="col-md-12">
            <div class="row rb-panel">
                <div class="text-center mb-4">
                    ...
                    <a id="section_user" class="hof_section_active" href="<?php echo Config::Get('SERVER_URL'); ?>HallOfFame"></a>
