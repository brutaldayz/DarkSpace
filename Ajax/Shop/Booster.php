<?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $Param1 = in_array($Param1, ["dmg-b01","dmg-b02","ep-b01","ep-b02","hon-b01","hon-b02","hp-b01","hp-b02","rep-b01","rep-b02","shd-b01","shd-b02"]) ? $Param1 : die(json_encode(["error" => true, "msg" => Lang::Get('equippingWrongError')]));
