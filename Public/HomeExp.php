        ...
        <div class="col-md-12">
            <div class="row rb-panel">
                <div class="text-center mb-4">
                    ...
                    <a id="section_exp" class="hof_section_active" href="<?php echo Config::Get('SERVER_URL'); ?>HomeExp"></a>
                ...
                <div class="full-width text-center halloffame_title mb-2">
                    <?php echo Lang::Get('ExpRank'); ?>
                </div>

                <div class="full-width halloffame_table_limited">
                    <table class="halloffame_table full-width">
                        <?php Rank::GetHallOfFameRanking($Player->Data['userID'], 'experience', 250); ?>
                    </table>
                </div>
            </div>
        </div>
